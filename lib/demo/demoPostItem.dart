...
import 'package:social_app/demo/chewie_demo.dart';
import 'package:social_app/demo/videoPost.dart';
...
Widget rectBarDecoContainer({
  required Widget reactionChild,
}){
  return Container(
    padding: const EdgeInsetsDirectional.only(start: 20,end: 20,top: 5,bottom: 2),
    decoration: BoxDecoration(
